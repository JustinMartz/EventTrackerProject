...
INSERT INTO `guitar` (`id`, `make`, `model`, `year`, `color`, `scale_length`, `number_of_frets`, `has_case`, `image_url`, `bridge`, `tuning_id`) VALUES (2, 'Gibson', '80s Explorer', 2022, 'Black', 24.75, 22, 1, 'explorer.jpg', 'Tune-O-Matic', 3);
INSERT INTO `guitar` (`id`, `make`, `model`, `year`, `color`, `scale_length`, `number_of_frets`, `has_case`, `image_url`, `bridge`, `tuning_id`) VALUES (3, 'Fender', 'American Professional Telecaster', 2018, '2-Color Sunburst', 25.5, 22, 1, 'tele.jpg', '3-Saddle', 1);
